...
if("TRUE" STREQUAL "TRUE")
  set(main_node_SOURCE_PREFIX /home/cc/ee106a/fl21/class/ee106a-aaf/ros_workspaces/final-project-workspace/src/main_node)
  set(main_node_DEVEL_PREFIX /home/cc/ee106a/fl21/class/ee106a-aaf/ros_workspaces/final-project-workspace/devel)
  ...
  set(main_node_INSTALL_PREFIX /home/cc/ee106a/fl21/class/ee106a-aaf/ros_workspaces/final-project-workspace/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'main_node' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'main_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fl21/class/ee106a-aaf/ros_workspaces/final-project-workspace/src/main_node/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT main_node_NUM_DUMMY_TARGETS)
      set(main_node_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::main_node::wrapped-linker-option${main_node_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR main_node_NUM_DUMMY_TARGETS "${main_node_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::main_node::wrapped-linker-option${main_node_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND main_node_LIBRARIES "${interface_target_name}")
